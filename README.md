...
| 2025 | [KORAIA_result](https://github.com/NoelClay/TourAgent) | AI-DX | `Django` `RAG` `LangChain` `APIs(NAVER, Google, KMA)` |
| 2024 | [KOSA_result](https://github.com/NoelClay/KOSAFIA) | Full-stack | `Spring Boot` `WebSocket` `React` |
